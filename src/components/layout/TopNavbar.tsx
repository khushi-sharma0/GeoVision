...
export const TopNavbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-6 shrink-0 transition-colors">
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-block px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-blue-50 text-blue-700 rounded border border-blue-200">
                3D Cadastre
              </span>
            </div>
            <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold leading-none mt-0.5">
        ...
        <div ref={searchRef} className="relative flex-1 max-w-xl px-2 sm:px-6 hidden sm:block">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-slate-100 border-none rounded-full py-1.5 pl-10 pr-9 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all font-sans"
            />
            {searchQuery && (
              <button
          ...
          {isSearchOpen && filteredResults && filteredResults.totalCount > 0 && (
            <div className="absolute top-12 left-0 w-full bg-white rounded-xl shadow-2xl border border-slate-200 p-2 z-50 max-h-96 overflow-y-auto">
                ...
                <div className="mb-2">
                  ...
                  {filteredResults.units.map((u) => (
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-2 text-left rounded-lg hover:bg-slate-100 transition-colors"
                    >
                      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-1.5 hover:bg-slate-100 rounded-full text-slate-500 transition-colors"
            >
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-slate-200 p-3 z-50">
                ...
                <div className="space-y-2">
                  <div
                    ...
                    className="p-2 rounded-lg bg-red-50 border border-red-200 cursor-pointer hover:bg-red-100/80 transition-colors"
                  >
                  ...
                  <div
                    ...
                    className="p-2 rounded-lg bg-amber-50 border border-amber-200 cursor-pointer hover:bg-amber-100/80 transition-colors"
                  >
          ...
          {/* Admin User Profile */}
          <div className="relative border-l pl-4 border-slate-200 flex items-center gap-2.5">
            <button
              onClick={() => setIsAdminMenuOpen((prev) => !prev)}
              className="flex items-center gap-2 hover:opacity-80 transition-opacity text-left cursor-pointer"
            >
              <div className="w-7 h-7 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-[11px] shadow-xs">
            ...
            {isAdminMenuOpen && (
              <div className="absolute right-0 top-10 w-64 bg-white rounded-xl shadow-2xl border border-slate-200 p-2 z-50">
                ...
                <div className="pt-1 border-t border-slate-100">
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 text-xs text-red-600 hover:bg-red-50 rounded-lg flex items-center gap-2 font-semibold cursor-pointer"
                  >
